...
const App = ({navigation}) => {  
  ...
  return (  
    ...
    <SafeAreaView style={[styles.container, { backgroundColor:  '#fff'}]}>  
      ...
      <TextInput style={{ marginTop: 2,height: 40,width:400, borderColor: 'gray', borderWidth: 1, marginBottom: 10, paddingHorizontal: 10,borderRadius:10 }} placeholder="User Name" value={text} onChangeText={(text)=>{
        setText(text);
      }} />

<TextInput style={{ marginTop:2,height: 40, width: 400, borderColor: 'gray', borderWidth: 1, marginBottom: 10, paddingHorizontal: 10 ,borderRadius:10}} placeholder="password" value={password} onChangeText={(text)=>{
        setPassword(text);
      }} />
      ...
      <Button title="Signup" onPress={() => Alert.alert("Standard button pressed")} />  
